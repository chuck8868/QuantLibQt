...
namespace NamespaceInflationCPICapFloorTest {
    ...
    void InflationCPICapFloorTest::cpicapfloorpricesurface() {
        ...
        <Bilinear> cpiSurf(nominal,
         ...
         std::cout << "Reproducing cpi floor data from cpi surface" << std::endl;
        ...
        std::cout << "Reproducing cpi cap data from cpi surface" << std::endl;
...
namespace NamespaceCPISwapTest {
    ...
    void CPISwapTest::myinflationcpiswap() {
        ...
        */
        ...
        std::cout << "Forward Rates:" << std::endl;
    ...
    void CPISwapTest::realInterestRateTS() {
        ...
        for(Size i=0; i<24; ++i) {
            std::cout << std::setw(2) << i << ": "
                      << std::setw(10) << d
                      << std::setw(7) << common.nominalTS->discount(d, true)
                      << std::setw(7) << common.nominalTS->zeroRate(d, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::setw(7) << common.nominalTS->forwardRate(d, d+1*Months, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::endl;
            d += 1*Months;
        }

        std::cout << "\n(2) Inflation swap break-even fixed rates" << std::endl;
        d = Date(1, December, 2009);
        for(Size i=0; i<24; ++i) {
            std::cout << std::setw(2) << i << ": "
                      << std::setw(10) << d
                      << std::setw(7) << common.cpiTS->zeroRate(d, common.observationLag, false, true)
                      << std::endl;
            d += 1*Months;
        }

        std::cout << "\n(3) Real interest rates" << std::endl;
    ...
    void YYIISTest::testYYIIS() {
        ...
        */
        ...
        for(Size i=0; i<20; ++i) {
            std::cout << std::setw(2) << i << ": " << "\t"
                      << std::setw(7) << dd << "\t"
                      << std::setw(7) << common.yoyIndexEU->fixing(dd, true)
                      << std::endl;            
            dd += 1*Months;
        }
        ...
        for(Size i=0; i<26; ++i) {
            std::cout << std::setw(2) << i << ": " << "\t"
                      << std::setw(7) << ddd << "\t"
                      << std::setw(7) << std::setprecision(5) << common.yoyEU->yoyRate(ddd, Period(-3, Months), false, true)
                      << std::endl;
            ddd += 1*Months;
        }
        ...
        for(Size i=0; i<30; ++i) {
            std::cout << std::setw(2) << i << ": "
                      ...
                      << std::setw(7) << std::setprecision(5) <<  common.nominalEUR->zeroRate(d, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::setw(7) << std::setprecision(5) <<  common.nominalEUR->forwardRate(d, d+1*Months, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::endl;
            d += 1*Months;
        }
    ...
    void YYIISTest::testYYIISFairRates() {
        ...
        */
        ...
        for(Size i=0; i<26; ++i) {
            std::cout << std::setw(2) << i << ": " << "\t"
                      << std::setw(10) << ddd << "\t"
                      << std::setw(7) << common.yoyEU->yoyRate(ddd, Period(-3, Months), false, true)
                      << std::endl;
            ddd += 1*Months;
        }
        ...
        for(Size i=0; i<30; ++i) {
            std::cout << std::setw(2) << i << ": "
                      ...
                      << std::setw(7) << common.nominalEUR->zeroRate(d, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::setw(7) << common.nominalEUR->forwardRate(d, d+1*Months, Actual365Fixed(), Compounded, Monthly, true).rate()
                      << std::endl;
            d += 1*Months;
        }
